...
$cronList = array(
	...
	"每12小时校时电子钟" => "* */12 * * * sqlite3 /var/www/db/smarthome.sqlite3 \"update tabDataToNode set fldData1=strftime('%H','now','localtime'), fldData2=strftime('%M', 'now','localtime'), fldData3=strftime('%S','now','localtime'), fldUpdatedOn=datetime('now', 'localtime'), fldUpdatedBy='cron' where fldNodeID=203\"",
	...
	"每天17:10打开客厅落地灯、台灯" => "10 17 * * * sqlite3 /var/www/db/smarthome.sqlite3 \"update tabDataToNode set fldData3=1, fldUpdatedOn=datetime('now', 'localtime'), fldUpdatedBy='cron' where fldNodeID=53; update tabDataToNode set fldData5=1, fldUpdatedOn=datetime('now', 'localtime'), fldUpdatedBy='cron' where fldNodeID=51\"",

	"每天18:30阳台窗帘全关" => "30 18 * * * sqlite3 /var/www/db/smarthome.sqlite3 \"update tabDataToNode set fldData1=1, fldData2=20, fldData4=100, fldUpdatedOn=datetime('now', 'localtime'), fldUpdatedBy='cron' where fldNodeID=62\"",
	...
	"每天22:30关闭热水器" => "30 22 * * * sqlite3 /var/www/db/smarthome.sqlite3 \"update tabDataToNode set fldData6=0, fldUpdatedOn=datetime('now', 'localtime'), fldUpdatedBy='cron' where fldNodeID=91\"",

	"每天22:35打开南卧射灯" => "35 22 * * * sqlite3 /var/www/db/smarthome.sqlite3 \"update tabDataToNode set fldData3=1, fldData4=1, fldUpdatedOn=datetime('now', 'localtime'), fldUpdatedBy='cron' where fldNodeID=83 and (fldData3=0 and fldData4=0)\"",
