...
#define RECEIVE_RF_CHANNEL 95 //本节点的接收频道号
#define HOST_RF_CHANNEL 92  //主机的接收频道号
#define HOST_DATA_WIDTH 1  //主机接收的数据宽度 15字节
#define ADDRESS_WIDTH 3 //发送和接收的地址宽度 3字节
#define NODE_ID_0 100 //NODE ID 0
#define NODE_ID_1 8 //NODE ID 1

static unsigned char MY_ADDR[ADDRESS_WIDTH] = {97, 83, 163 }; //本节点地址
