...
#define RECEIVE_DATA_WIDTH 0 //本节点的接收的数据宽度 0字节表示本节点不接收数据
...
static byte MY_ADDR[ADDRESS_WIDTH] = { 97, 83, 153 }; //本节点地址
static byte HOST_ADDR[ADDRESS_WIDTH]= { 53, 69, 149 }; //主机节点地址
