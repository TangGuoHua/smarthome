...
function setMode( modeName )
{
	...
	else if( modeName == 'WatchTV' ) // 看电视
	{
		...
		$.post("/api/sendData.php", { nodeID: "51", data2:1, data4:1, data5:1, data6:1 } ); //开电信机顶盒、电视、台灯、天猫盒子
	...
	{
		$.post("/api/sendData.php", { nodeID: "41", data1:0, data2:0, data3:0, data4:0 } ); //关餐厅射灯
		$.post("/api/sendData.php", { nodeID: "51", data3:0, data4:0, data5:0, data6:0, data7:0, data8:0, data9:0} ); //关电视墙上的电器
		$.post("/api/sendData.php", { nodeID: "53", data1:0 } ); //关客厅落地灯
